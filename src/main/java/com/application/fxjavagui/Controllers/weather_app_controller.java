package com.application.fxjavagui.Controllers;

import com.application.fxjavagui.Controllers.Exceptions.AppExceptions;
import com.application.Application.AppMain;
import com.application.MainClasses.*;
import com.application.Application.GettingApiData;
import com.application.fxjavagui.Controllers.Exceptions.LocalisationSyntaxException;
import com.application.fxjavagui.Controllers.Exceptions.NotGivenInputException;
import com.application.fxjavagui.Controllers.Exceptions.PlaceExistingException;
...
public class weather_app_controller implements Initializable {
    ...
    private main_application_weather mainWeather;
            ...
            for (Map.Entry<Object[], Label> choice : Choices.entrySet()) {
                try {
                    ...
                    if (box.isSelected()) {
                        ...
                        } else if (keyObject instanceof feels_like) {
                            valueLabel.setText(((feels_like) keyObject).show("long"));
